...
class RoomStatusChangeServiceTest {
    ...
    @Mock private RoomStatusChangeExecutor executor;
    ...
    void 취소가_세_번_낙관_락_충돌하면_동시_변경_오류를_반환한다() {
        ...
        BusinessException exception =
                assertThrows(BusinessException.class, () -> service.cancelRoom(USER_ID, ROOM_ID));
    ...
    void 세_번_낙관_락_충돌하면_동시_변경_오류를_반환한다() {
        ...
        BusinessException exception =
                assertThrows(BusinessException.class, () -> service.finishRoom(USER_ID, ROOM_ID));
