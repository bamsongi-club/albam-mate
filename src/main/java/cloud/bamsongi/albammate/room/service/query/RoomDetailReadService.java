...
class RoomDetailReadService {
	...
	public RoomDetailReadResult findRoomDetail(Long roomId, Long currentUserId) {
		...
		boolean currentUserWaiting = currentUserId != null && roomWaitlistRepository
	...
	RoomDetailReadResult findRoomDetail(Long roomId) {
		return findRoomDetail(roomId, null);
	}

	public record RoomDetailReadResult(
		Room room, List<Participation> activeParticipations, boolean currentUserWaiting) {

		public RoomDetailReadResult(Room room, List<Participation> activeParticipations) {
			this(room, activeParticipations, false);
		}
	}
}
