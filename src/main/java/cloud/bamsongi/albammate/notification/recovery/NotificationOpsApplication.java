...
@ComponentScan(basePackageClasses = NotificationOutboxRecoveryService.class, excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = NotificationOpsApplication.class))
