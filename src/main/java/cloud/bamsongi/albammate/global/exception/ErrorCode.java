...
public enum ErrorCode {
	...
	RATE_LIMIT_EXCEEDED(HttpStatus.TOO_MANY_REQUESTS, "요청 처리 한도를 초과했습니다. 잠시 후 다시 시도해 주세요."),
	...
	ASSISTANT_DRAFT_NOT_FOUND(HttpStatus.NOT_FOUND, "AI 초안을 찾을 수 없습니다."),
	ASSISTANT_DRAFT_EXPIRED(HttpStatus.GONE, "AI 초안이 만료되었습니다."),
	ASSISTANT_DRAFT_CONFLICT(HttpStatus.CONFLICT, "AI 초안이 동시에 변경되었습니다. 다시 확인해 주세요."),
	ASSISTANT_INPUT_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "외부 AI 처리에 허용되지 않는 입력입니다."),
	ASSISTANT_PROVIDER_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "AI provider를 현재 사용할 수 없습니다."),
