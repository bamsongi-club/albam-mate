...
export function renderMechanismUpsertSql(catalog, relations) {
	return renderMechanismUpsertSqlWithoutDescription(catalog, relations)
		.replace("name_en VARCHAR(100) NOT NULL,\n    featured_order", "name_en VARCHAR(100) NOT NULL,\n    description_ko VARCHAR(300) NOT NULL,\n    featured_order")
		.replace("name_ko, name_en, featured_order,\n    source_reference", "name_ko, name_en, description_ko, featured_order,\n    source_reference")
		.replace("name_ko, name_en, featured_order, is_public,\n    source_reference", "name_ko, name_en, description_ko, featured_order, is_public,\n    source_reference")
		.replace("name_ko, name_en, featured_order, true,", "name_ko, name_en, description_ko, featured_order, true,")
		.replace("name_en = EXCLUDED.name_en,\n    featured_order", "name_en = EXCLUDED.name_en,\n    description_ko = EXCLUDED.description_ko,\n    featured_order")
		.replace("INSERT INTO game_mechanisms (\n", `UPDATE game_mechanisms mechanism
