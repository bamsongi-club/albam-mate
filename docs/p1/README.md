...
| [소셜 로그인](auth.md) | `AUTH-05`의 Google·Naver·Kakao 로그인과 기존 계정의 명시적 연결 |
...
| --- | --- | --- | --- | --- |
| [`AUTH-05`](auth.md#auth-05-소셜-로그인계정-연결) | 선행 계약 필요 | 미구현 | 미검증 | 미배포·미측정 |
