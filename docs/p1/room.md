...
| 후속 구현 | [#557](https://github.com/bamsongi-club/albam-mate/issues/557)에서 ADR-0055·0056·0057의 목록·내 모임 유효 상태·snapshot 경계를 생산 코드와 PostgreSQL 회귀로 반영한다. |
