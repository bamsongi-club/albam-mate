...
- 작성일: 2026-08-03
- 결정일: 2026-08-03
- 관련: [AUTH-05](../../archive/p1/social-login.md#auth-05-소셜-로그인계정-연결), [API](../../API.md#auth-05-소셜-로그인계정-연결), [ERD](../../ERD.md#social_accounts), [GitHub Issue #328](https://github.com/bamsongi-club/albam-mate/issues/328)
- 대체 대상: 없음
- 후속 ADR: 없음

> 이 결정은 #328과 PR #337의 팀 검토를 거쳐 채택됐다. 구현·검증 상태는 아래 검증 절과 [P1 기능 종료 상태](../../archive/p1/README.md#기능별-종료-상태)을 따른다.
...
- 다시 검토할 조건: 제공자 캘린더·프로필 API처럼 로그인 이후 권한이 필요한 기능을 승인하거나 실제 계정 병합·연결 해제 요구가 확인될 때
