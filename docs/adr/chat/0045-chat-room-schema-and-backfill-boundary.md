...
- 상태: 미검증
- 근거:
    - 계약: #279 승인 코멘트가 V6 스키마 전용 T1~T4를 확정하고, #281 이슈가 기존 ROOM backfill·경합·절체의 후속 범위를 기록한다. 이는 구현·테스트 범위의 근거이며 ADR-0045의 채택 근거는 아니다.
- 미검증:
    - ADR-0045 자체에 대한 사용자·팀 채택 기록이 아직 없다.
