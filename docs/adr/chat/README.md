...
| [0034](0034-chat-message-retention-and-deletion.md) | 최종 상태 채팅 메시지를 30일 보관한 뒤 일괄 삭제 | 승인됨 | 2026-08-01 | 미검증 |
| [0041](0041-chat-room-schema-and-backfill-boundary.md) | 채팅방 스키마 생성과 기존 ROOM backfill 실행 경계 분리 | 제안됨 | 미정 | 미검증 |
