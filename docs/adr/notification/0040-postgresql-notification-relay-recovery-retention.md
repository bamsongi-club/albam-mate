...
- 근거:
    ...
    - 테스트:
        ...
        - [알림 broker 판단서](../../measurements/k6/jiho/notification-broker-decision-2026-08-11.md)는 이 유효 범위에서 p95 30초·oldest age 60초 목표를 충족하고 DB lock·미수렴 backlog 문제가 없었음을 확인한다. 0.5×·1× 혼합 부하는 App cgroup OOM으로 `INVALID`이므로 relay의 지속 처리 용량 경계나 broker 전환 근거로 사용하지 않는다.
