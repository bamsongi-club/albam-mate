...
170,000행 성능 fixture는 운영 적재에 쓰지 않고 PostgreSQL 대표 조합의 EXPLAIN ANALYZE와 응답 시간만 재현한다. 관계 복합 키와 FK 유지에 필요한 인덱스 외의 역방향 검색 인덱스, cache, Redis, 검색 엔진, pg_trgm은 넣지 않는다.
