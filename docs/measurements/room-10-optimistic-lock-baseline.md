...
측정 round의 재생성 파일은 <code>build/reports/measurements/room-10c.json</code>이다. 이 경로는 build 산출물이므로 버전 관리 증거 파일로 취급하지 않는다. 아래 표는 이 문서를 작성할 때 실행한 파일의 수치를 옮긴 것이며, 다시 실행하면 응답시간과 PostgreSQL 비용은 달라질 수 있다.
...
| 항목 | 값 |
| --- | --- |
| 기준 SHA | <code>a56d7e0cdb1f0023e56f1743e468c2e0ff132779</code> |
| Java | 21.0.11 |
...
| 동시 요청 수준 | 2 |
| 시작 heap / 최대 heap | 241,008,880 B / 536,870,912 B |
...
| --- | --- | ---: | ---: | ---: | --- |
| 직접 참가 | 상태 보정 먼저 | 3 / 3 / 0 / 0 | 0 / 0 / 0 | 6.4114 / 13.8262 / 13.8262 | calls 7, rows 3, hit 16, read 0; exec 0.1564 / 0.2911 / 0.2911 ms |
| 직접 참가 | 명령 먼저 | 3 / 3 / 0 / 0 | 0 / 0 / 0 | 12.2196 / 18.5046 / 18.5046 | calls 7, rows 3, hit 16, read 0; exec 0.1753 / 0.1840 / 0.1840 ms |
| 대기 등록 | 상태 보정 먼저 | 3 / 3 / 0 / 0 | 0 / 0 / 0 | 8.2797 / 15.8774 / 15.8774 | calls 7–8, rows 3–5, hit 13–32, read 0; exec 0.1795 / 0.2656 / 0.2656 ms |
| 대기 등록 | 명령 먼저 | 3 / 3 / 0 / 0 | 0 / 0 / 0 | 7.5770 / 8.8660 / 8.8660 | calls 7, rows 3, hit 13, read 0; exec 0.1536 / 0.1648 / 0.1648 ms |
| 참가 취소·자동 승격 | 상태 보정 먼저 | 3 / 3 / 0 / 0 | 0 / 0 / 0 | 8.4988 / 14.8997 / 14.8997 | calls 6, rows 4, hit 13, read 0; exec 0.1370 / 0.1705 / 0.1705 ms |
| 참가 취소·자동 승격 | 명령 먼저 | 3 / 3 / 0 / 0 | 0 / 0 / 0 | 7.3868 / 12.3190 / 12.3190 | calls 6, rows 4, hit 13, read 0; exec 0.1472 / 0.2457 / 0.2457 ms |
| 대기 취소 | 상태 보정 먼저 | 3 / 3 / 0 / 0 | 0 / 0 / 0 | 6.4918 / 15.2879 / 15.2879 | calls 6, rows 4, hit 19, read 0; exec 0.1587 / 0.2402 / 0.2402 ms |
| 대기 취소 | 명령 먼저 | 6 / 0 / 0 / 0 | 0 / 0 / 0 | 8.6828 / 16.6976 / 16.6976 | calls 6, rows 4, hit 19, read 0; exec 0.2447 / 0.2968 / 0.2968 ms |
...
| room-10c | build 재생성 파일 | <code>a56d7e0cdb1f0023e56f1743e468c2e0ff132779</code> | 2 | 24 | 시작 경계의 네 명령과 두 확정 순서 |
...
명령이 성공하면 <code>build/reports/measurements/room-10c.json</code>을 생성한다. 결과를 갱신할 때는 문서의 실행 환경·수치·해석 경계를 같은 실행 결과에 맞춰 함께 갱신한다.
