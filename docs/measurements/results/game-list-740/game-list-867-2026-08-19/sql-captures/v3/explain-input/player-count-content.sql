-- v3/player-count content read
-- source=docs/measurements/results/game-list-740/game-list-867-2026-08-19/sql-captures/v3/player-count.postgres.log
-- captured_execute_duration_ms=1.664
