-- v2/player-count slowest read
-- source=docs/measurements/results/game-list-740/game-list-867-2026-08-19/sql-captures/v2/player-count.postgres.log
-- captured_execute_duration_ms=5.706
