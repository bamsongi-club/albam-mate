...
| --- | --- | --- | --- | --- | --- | --- |
| `auth-notification-20260811T021040KST` | 2026-08-11 02:10:40~10:36:50 KST | `completed-with-limitations` | [인증·알림 AWS 용량 측정](jiho/auth-notification-capacity-2026-08-11.md) | [알림 broker 판단](jiho/notification-broker-decision-2026-08-11.md) | [campaign manifest](jiho/evidence/auth-notification-capacity-2026-08-11.json) | 최초 캠페인, 후속 `tomcat64-20260811`이 기존 결론을 대체하지 않음 |
...
| `tomcat64-20260811` | 2026-08-11 21:50:40~22:06:03 KST | `INVALID` | [Tomcat 64 알림 혼합 부하 재측정](jiho/notification-tomcat64-capacity-2026-08-11.md) | 기존 판단 유지 | [campaign evidence](jiho/evidence/notification-tomcat64-capacity-2026-08-11.json) | `auth-notification-20260811T021040KST`의 후속, 대체하지 않음 |
...
| `t4gsmall-20260812` | 2026-08-12 10:09:50~10:25:10 KST | `INVALID` | [t4g.small 알림 혼합 부하 단일 측정](jiho/notification-t4gsmall-capacity-2026-08-12.md) | 기존 판단 유지 | [campaign evidence](jiho/evidence/notification-t4gsmall-capacity-2026-08-12.json) | `tomcat64-20260811`의 후속, OOM 제거만 확인하고 용량 경계는 대체하지 않음 |
| `redis-session-diagnostic-20260812` | 2026-08-12 11:42:54~21:33:05 KST | `completed` | [Redis 세션 연결 진단·A/B](jiho/redis-session-connection-diagnostic-2026-08-12.md) | 해당 없음 | [진단 evidence](jiho/evidence/redis-session-connection-diagnostic-2026-08-12.json) | Issue #607 후보 A/B와 mixed 0.5× 검증 완료 |
