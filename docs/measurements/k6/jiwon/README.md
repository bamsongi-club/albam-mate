...
| 07. `room-t5-repeated-baseline-2026-08-18` | `completed-with-limitations` | [T5 반복 기준선 — INVALID (2026-08-18)](room-t5-repeated-baseline.md) | `INVALID` · 6개 canonical fixture 1회씩, 조건별 3회 요구 중 12회 미실행; run-manifest 0·comparison accepted 0 · [campaign evidence](evidence/room-t5-repeated-baseline.json) | `current` · 실행 기록; 기존 correctness 기준선 대체 안 함 |
