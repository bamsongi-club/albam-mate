...
| `chat-delivery-capacity-2026-08-13` | `completed-with-limitations` | [채팅 전송·전달 AWS 용량 측정 — #608 반영 후](chat-delivery-capacity-2026-08-13.md) | [campaign manifest](evidence/chat-delivery-capacity-2026-08-13.json) | 동일 release 반복 `chat-delivery-capacity-2026-08-13-repeat2`가 대체 |
| `chat-delivery-capacity-2026-08-13-repeat2` | `completed-with-limitations` | [채팅 전송·전달 AWS 용량 반복 측정 — #608 반영 후 반복](chat-delivery-capacity-2026-08-13-repeat2.md) | [campaign manifest](evidence/chat-delivery-capacity-2026-08-13-repeat2.json) | 동일 release(`69438fd3`) 반복. `chat-delivery-capacity-2026-08-13`을 대체 |
