...
| `chat-delivery-20260812T213324KST` | `completed` | [채팅 전송·전달 AWS 용량 측정 — #607 수정 후](chat-delivery-capacity-2026-08-12-after-607.md) | [campaign manifest](evidence/chat-delivery-capacity-2026-08-12-after-607.json) | 대체 없음. release 변경(`b6c32e22`), before 기준선 `chat-delivery-20260812T090111KST` |
