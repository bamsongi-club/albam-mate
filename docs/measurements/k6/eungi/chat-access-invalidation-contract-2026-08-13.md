...
재실행에는 PR #679의 [실행 안내](https://github.com/bamsongi-club/albam-mate/blob/afa6cdd7a8436aebdd2b1f2145522fa622a16de8/load-tests/k6/eungi/README.md#실행)를 사용한다. 이 검증과 같은 조건을 만들려면 다음을 함께 만족해야 한다.
