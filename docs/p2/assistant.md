...
소유자 `알밤메이트 AI 모임 도우미 담당자` · 최종 검증일 `2026-08-18` · 결정 정본 `ADR-0074~0076, ADR-0085, ADR-0089` · 상세 검증 정본 `assistant-load-test.md`
