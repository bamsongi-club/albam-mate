...
| [`CHAT-08` 채팅 목록 실시간 갱신](chat.md#chat-08-채팅-목록-실시간-갱신) | 사용자 단위 실시간 채널로 목록 화면에 머무는 동안 마지막 메시지·미읽음·방 정렬을 즉시 갱신 | 계약 준비 완료([ADR-0082](../adr/chat/0082-chat-list-per-user-realtime-channel.md)·[문서 이슈 #913](https://github.com/bamsongi-club/albam-mate/issues/913) 완료), 구현 필요 |
...
| 채팅 목록 실시간 갱신 | [`CHAT-08`](chat.md#chat-08-채팅-목록-실시간-갱신) | 계약 준비 완료 | 미구현 | 미검증 | 미배포 | 미측정 |
