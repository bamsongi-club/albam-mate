...
| [`CHAT-07` 채팅 목록 마지막 메시지·미읽음 상태](chat.md#chat-07-채팅-목록-마지막-메시지방별-미읽음-상태) | 방별 읽음 커서 저장, 채팅 목록 마지막 메시지·미읽음 집계, 읽음 처리 API와 상단 배지 요약 | 계약 준비 완료·부분 구현(백엔드 저장·읽음 처리 API 완료, 상단 배지 요약·프런트엔드 구현 예정) |
...
| 채팅 목록 마지막 메시지·미읽음 | [`CHAT-07`](chat.md#chat-07-채팅-목록-마지막-메시지방별-미읽음-상태) | 계약 준비 완료 | 부분 구현 | 부분 검증 | 미배포 | 미측정 |
