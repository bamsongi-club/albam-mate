...
| 실시간 파티 매칭 | [`MATCH-01`](matching.md#match-01-실시간-파티-매칭) | 계약 준비 완료 | 부분 구현 | 부분 검증: #746 gate `ACCEPTED` (T1·T5~T7·T12, #775 candidate, #776 response); T2~T4·T8~T9 미검증, T10~T11 전후 비교 미완료 | 미배포 | candidate claim·응답 완료 baseline `ACCEPTED`; 운영 실측 미측정 |
