...
| AI 사용량·추정 비용 | [`OPS-04`](monitoring.md#ops-04-ai-사용량과-추정-비용) | T1~T6 승인 완료 | 앱 usage·cost-warning consumer, 공식 가격 snapshot·계산기와 비공개 인프라 dashboard·alarm 골격 구현. 가격 적격성·cardinality gate·P2 전체 비용은 미구현 | 앱 meter와 snapshot 계산기 검증 완료. dashboard 미관측 경계·실제 cardinality·T5 전체 비용 검증은 미완료 | 미배포 | 미측정 |
