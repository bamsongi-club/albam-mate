...
| [`AI-01` AI 모임 도우미](assistant.md#ai-01-ai-모임-도우미) | 사용자 동의·철회, assistant 진입·화면, 추천·확인 흐름과 기존 수동 Room 회귀 | 제품 계약 확정·T-ID 승인 완료·AI-01a T1~T5 구현·검증 완료 |
...
| `CHAT-08` 채팅 목록 실시간 갱신 (명세는 [문서 이슈 #913](https://github.com/bamsongi-club/albam-mate/issues/913) 완료 후 `chat.md`에 등록) | 사용자 단위 실시간 채널로 목록 화면에 머무는 동안 마지막 메시지·미읽음·방 정렬을 즉시 갱신 | [ADR-0082](../adr/chat/0082-chat-list-per-user-realtime-channel.md) 승인 완료·기능 명세 작성 필요 |
...
| --- | --- | --- | --- | --- | --- | --- |
| AI 모임 도우미 | [`AI-01`](assistant.md#ai-01-ai-모임-도우미) | T-ID 승인 완료 | AI-01a T1~T5 동의·철회·인증·CSRF·추천 orchestration/candidate 경계 구현, AI-01b는 후속 | H2·PostgreSQL T1~T5 통과 | 미배포 | 미측정 |
...
| 채팅 목록 실시간 갱신 | `CHAT-08`([문서 이슈 #913](https://github.com/bamsongi-club/albam-mate/issues/913)) | 기능 명세 필요 | 미구현 | 미검증 | 미배포 | 미측정 |
