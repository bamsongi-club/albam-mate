...
| [`CHAT-07` 채팅 목록 마지막 메시지·미읽음 상태](chat.md#chat-07-채팅-목록-마지막-메시지방별-미읽음-상태) | 방별 읽음 커서 저장, 채팅 목록 마지막 메시지·미읽음 집계, 읽음 처리 API와 상단 배지 요약 | 제품 계약 확정·T-ID 승인 필요·구현 보류 |
...
| 채팅 목록 마지막 메시지·미읽음 | [`CHAT-07`](chat.md#chat-07-채팅-목록-마지막-메시지방별-미읽음-상태) | T-ID 승인 필요 | 미구현 | 미검증 | 미배포 | 미측정 |
