...
| 실시간 파티 매칭 | [`MATCH-01`](matching.md#match-01-실시간-파티-매칭) | 계약 준비 완료 | 부분 구현 | 부분 검증: #746 gate manifest는 `MATCH_01_FUNCTIONAL_GATE_ACCEPTED_WITH_T10_DEFERRED`를 기록하고 T10 유예를 포함한다.<br>검증 완료: T1·T5~T7·T12, #775 candidate, #776 response evidence는 기능·정합성 범위의 gate 입력으로 채택됐고, #1000 T11 before/after 비교는 자체 계약에서 `RESPONSE_COMPARISON_ACCEPTED`로 판정됐다.<br>미검증: T2~T4·T8~T9와 현재 `develop`의 gate 재검증은 완료되지 않았다. T10은 ADR-0091에 따라 자동 gate에서 유예됐다. | 미배포 | 미측정 |
