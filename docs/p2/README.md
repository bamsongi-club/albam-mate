...
| [운영 관측](monitoring.md) | `OPS-01`~`OPS-05`의 기능별 지표·로그·검증 기준과 제외 범위 | OPS-01·OPS-02·OPS-03 구현·자동 검증·임시 AWS 실측·철거 완료, 미배포 외부 API·AI·Tool은 해당 완료 기준에서 조건부 제외 |
