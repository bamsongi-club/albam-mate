...
| [운영 관측](monitoring.md) | `OPS-01`~`OPS-05`의 기능별 지표·로그·검증 기준과 제외 범위 | 정본 승격·전송 ADR·운영 계약 반영 |
...
| 서비스 생존·연결 | [`OPS-01`](monitoring.md#ops-01-서비스-생존과-연결-상태) | 계약 준비 완료 | 미구현 | 미검증 | 미배포 | 미측정 |
