...
- P2 AI provider·동의·초안·확인형 Room·지역 경계: [ADR-0068](adr/platform/0068-p2-ai-provider-consent-and-operation-boundary.md), [ADR-0069](adr/room/0069-p2-ai-draft-confirmation-and-idempotent-room-command.md), [ADR-0070](adr/room/0070-p2-room-region-closed-set-and-compatibility.md)
