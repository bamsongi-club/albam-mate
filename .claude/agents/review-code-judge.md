...
- 먼저 [.codex/agents/review-code-judge.toml](../../.codex/agents/review-code-judge.toml)을 읽고 `developer_instructions` 문자열의 지시를 그대로 따른다. 그 파일이 지시 정본이므로 이 문서에 요약본이나 사본을 두지 않는다.
