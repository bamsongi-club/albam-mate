...
알밤메이트 P0 화면과 현재 제공 중인 P1 기능을 백엔드 API에 연결한 React(Vite) 프론트엔드입니다. 구현 규칙과 실행 환경은 [프론트엔드 작업 안내](AGENTS.md), 기능별 현재 제공 여부는 [P1 기능 상태 정본](../docs/p1/README.md#기능별-현재-상태), 요청·응답·인증·CSRF 계약은 [API 명세](../docs/API.md)를 따릅니다.
