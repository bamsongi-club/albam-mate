...
const TABS = [
  ...
  { key: 'my', label: '내 모임', href: '#/my', requiresAuth: true },
...
export function mobileTabForRoute(route) {
  ...
  if (['my', 'create', 'edit', 'session', 'chat', 'chats'].includes(route)) return 'my';
  if (['profile', 'auth', 'signup'].includes(route)) return 'profile';
  return 'home';
}
